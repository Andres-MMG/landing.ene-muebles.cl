      ...
      *=\<generate-random\>)
        ...
        case "$key" in
          APP_KEYS)
            ...
            ;;
          API_TOKEN_SALT|ADMIN_JWT_SECRET|TRANSFER_TOKEN_SALT|JWT_SECRET|CLIENT_ADMIN_PASSWORD|MYSQL_PASSWORD|MYSQL_ROOT_PASSWORD|STRAPI_API_TOKEN|STRAPI_ADMIN_TOKEN|REVALIDATE_SECRET|ADMIN_SESSION_SECRET)
            value=$(random_hex 32)
            ;;
          *)

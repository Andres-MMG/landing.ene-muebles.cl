  ...
  return (
    <div className="mx-auto w-full max-w-[1440px] px-6 py-12 sm:px-10 lg:px-16 lg:py-16">
      <header className="border-b border-ink-line pb-8">
        <p className="t-mono text-[11px] uppercase tracking-[0.22em] text-taupe">Importación de catálogo</p>
        <h1 className="t-display mt-3 text-4xl">Importar productos</h1>
        <p className="mt-3 max-w-2xl text-sm text-ink-mute">Revisá y corregí el catálogo antes de enviarlo. El archivo se procesa únicamente en este navegador.</p>
      </header>
      <div className="mt-10">
        {allowed ? (
          ...
          <div className="border border-ink-line bg-paper-pure p-8">
            ...
            <Link href="/admin" className="mt-4 inline-block underline underline-offset-4">Volver al panel</Link>
          </div>
        )}
      </div>
    </div>
